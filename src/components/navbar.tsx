...
const NavBar = () => {
  return (
    <nav
      ...
      <div className='flex justify-between h-full  items-center w-full py-3 px-8 bg-primary-700 text-white'>
        <div className='items-center flex  gap-4 md:gap-6'>
          <Link
            className='cursor-pointer group group-hover:!text-primary-300'
            scroll={false}
            href='/'>
        ...
        <p className=' text-primary-200 hidden md:block'>
          Discover your perfect rental apartement with your  advanced search
        </p>
